  ...
  Game.prototype = {
    ...
    _drawPauseScreen: function() {
      ...
      switch (this.state.currentStatus) {
        case Verdict.WIN:
          drawMultiLineTxt(this, 'Уря! Я выйграл!', 110, 20, textX, y + 40, '#FFFFFF','rgba(36, 255, 0, 0.81)', 40);
        ...
        case Verdict.PAUSE:
          ...
          break;
        case Verdict.INTRO:
        drawMultiLineTxt(this, 'Нажми пробел для начала игры! Если не нажмешь, то не поиграешь, дружок! Давай-давай!', 120, 20, textX, y + 40, '#FF0000', 'rgb(251, 255, 252)', 10);
